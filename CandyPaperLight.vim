" Theme:        CandyPaperLight
" Author:       mkdong
" License:      MIT

" Origined from DF_XYZ's CandyPaper
...
let g:colors_name = "CandyPaperLight"
...
let s:purple       = "#afae30" "Repeat/Conditional
"let s:blue         = "#6fb5de" "Operator/Delimiter
let s:blue         = "#cfb5de" "Operator/Delimiter
